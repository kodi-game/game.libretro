...
GAME_ERROR CGameLibRetro::GetRichPresenceEvaluation(char* evaluation, size_t size, int consoleID)
{
  CCheevos::Get().EvaluateRichPresence(evaluation, size, consoleID);
